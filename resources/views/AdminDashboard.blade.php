    ...
    <div class="combine">
        <div class="sidebar">
          <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="logoutadmin" method="POST" class="nav-link "><i class="fa fa-sign-out"></i> Log Out</a>
                    </li>
        ...
        <div class="Accounts">
        <div class="h1" >Welcome To the Admin Dashboard</div>
        </div>
        <div class="container mt-0 mb-5">
        <div class="btn btn-danger">Sort</div>
        <!--<a href="{{URL::current().'?sort=price_asc'}}">ALL</a>-->
        </div>
        <div class="mt-5">
