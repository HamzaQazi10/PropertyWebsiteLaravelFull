...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark ">
    ...
    <div class="container">
      ...
      <div class="col-md-6">
    <form class="centre-form" onsubmit="return validation()" action="/EditInfo1/{{ $ad[0]->email }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="container my-5" id="backcolor" >
 

        <div class="form-row my-3 mt-5">
        <div class="form-group col-md-12">
          <label for="inputPhone" class="text-danger mt-4">Phone Number</label>
 ...
 <!--         <div class="form-group col-md-4">
       ...
       <!-- <div class="form-group">
        ...
        <input type="submit" class="btn btn-danger mb-5"></input>
      </div>
      </form>
    </div>
