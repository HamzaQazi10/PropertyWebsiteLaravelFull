...
<body>
    ...
    <div class="container">
      ...
      <div class="col-md-6">
    <form class="centre-form" onsubmit="return validation()" action="/signedin" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <form class="centre-form" action="/signup" method="POST" enctype="multipart/form-data">
      @csrf
      <button type="submit" class="btn btn-danger mb-4">Sign Up</button>
              </form>
    </div>
